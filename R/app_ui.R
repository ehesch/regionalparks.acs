  ...
  tagList(
    ...
    navbarPage("Regional Parks and Trails Equity Tool",
      ...
      tabPanel(
        ...
        fluidRow(
          column(width = 3, mod_input_demos_ui(id = "input_demos_ui_1")), #left off here, need to turn input demos into a util, and plot
      ...
      tabPanel(title = "Summary",
        ...
        tabsetPanel(
            ...
            tabPanel(
              ...
              mod_summary_download_ui("summary_download_ui_1"), br(),
